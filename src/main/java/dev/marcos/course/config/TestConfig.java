...
import dev.marcos.course.entity.*;
import dev.marcos.course.entity.enums.OrderStatus;
import dev.marcos.course.repository.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, LocalDateTime.parse("2025-06-20T21:53:07Z", DateTimeFormatter.ISO_DATE_TIME), o1);
        o1.setPayment(pay1);
